...
public class Infection {
	...
	// Increases the strength of the epidemic in the city by "increment". Spreads to
	// neighbor cities if neccesary
	...
	// TODO
	/*
	 * Spreads a disease to a neighbor city using its City object // Should call the
	 * "spreadToCity" method of the associated Disease object
	 */
