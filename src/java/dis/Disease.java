...
public class Disease {
	 ...
	 * 
	 * Alias must be unique. It'll be used as identifier. max_epidemics specifies
	 * the max number of epidemcs that specific disease will allow.
	 ** 
	...
	public static Hashtable<String, Disease> parseDis(String datafile) {
		...
		try {
			...
			// Reads disease data from subsequent lines (Must follow the expected disease
			// format)
	...
	public void spreadToCity(City c, int n_spreads) {
		...
		// If the number of spreads left gets depleated, then the disease overtakes the
		// world (game ends)
