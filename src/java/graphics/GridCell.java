...
public class GridCell extends Box{
  ...
  public void refresh(){
    ...
    // Updates city metainfo (iterates all inner grid cells to set the elements in the appropriate order)
  ...
  /*
    Redefinition. Overrides default paintComponent method
    Sets cell-specific background image
  */
  protected void paintComponent(Graphics g) {
    ...
    // Tries to load a specific sprite from the folder. If fail, then sets a default sprite
