...
public class Role{
  ...
  /*
    parseRoles
      Initializes roles from a datafile.
      Expected format (csv):
        <Role full name>;<alias>
  ...
  */
  public static Hashtable<String, Role> parseRoles(String datafile){
    ...
    try(BufferedReader br = new BufferedReader(new FileReader(datafile))){
      ...
      // Reads roles data from subsequent lines (Must follow the expected disease format)
      while((line = br.readLine()) != null){
        ...
        // Ideally, here must be resolved the specific role subclass by checking the role alias.
        /*
          Role prol;
          if(role_alias.equals(sci)){
            prol = new Role_Sci();
            ...
          }
        */
